...
/**
 * @file
 * Contains \Drupal\insert_svg\Form\InsertSvgDialog.
 */

namespace Drupal\insert_svg\Form;
 ...
 */
class InsertSvgDialog extends FormBase implements BaseFormIdInterface {
